...
class Command(BaseCommand):
    ...
    def handle(self,*args,**kwargs):
        roles={"ฝ่ายขาย":["add_bill","add_customer","add_payment"],"สต๊อก":["adjust_stock","add_product"],"ผู้จัดการ":["add_bill","add_customer","add_payment","adjust_stock","add_product","change_bill","change_payment","change_shopsettings"]}
